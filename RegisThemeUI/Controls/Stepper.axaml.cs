...
namespace RegisThemeUI.Controls
{
    public partial class Stepper : UserControl
    {
        ...
        private void AddStep(string step, int index,Grid grid)
        {
            ...
            Brush PrimaryColor = new SolidColorBrush( (Color)Application.Current.FindResource("RegisThemePrimaryColor"));
            Brush DisabledColor =  new SolidColorBrush( (Color)Application.Current.FindResource("RegisThemeControlBorderBrush"));
